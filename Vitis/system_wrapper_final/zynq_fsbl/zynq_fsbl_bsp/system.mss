...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = AES_ip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AES_ip_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = desip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = desip_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gcdip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = gcdip_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = inter_ip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = inter_ip_0
END
