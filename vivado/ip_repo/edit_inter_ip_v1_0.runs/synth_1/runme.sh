...
HD_PWD='c:/embeding_system/project_2_final/ip_repo/edit_inter_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inter_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inter_ip_v1_0.tcl
