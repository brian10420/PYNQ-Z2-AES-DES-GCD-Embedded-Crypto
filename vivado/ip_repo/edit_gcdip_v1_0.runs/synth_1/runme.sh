...
HD_PWD='D:/EOS/project/ip_repo/edit_gcdip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gcdip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gcdip_v1_0.tcl
