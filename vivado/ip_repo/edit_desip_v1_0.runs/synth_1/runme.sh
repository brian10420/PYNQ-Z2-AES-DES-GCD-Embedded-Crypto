...
HD_PWD='D:/EOS/project/ip_repo/edit_desip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log desip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source desip_v1_0.tcl
