...
HD_PWD='D:/EOS/project/ip_repo/edit_AES_ip_v10_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_ip_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_ip_v10_0.tcl
