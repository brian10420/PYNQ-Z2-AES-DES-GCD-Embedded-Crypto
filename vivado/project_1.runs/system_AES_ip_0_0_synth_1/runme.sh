...
HD_PWD='C:/embeding_system/project_2_final/project_1.runs/system_AES_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_AES_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_AES_ip_0_0.tcl
