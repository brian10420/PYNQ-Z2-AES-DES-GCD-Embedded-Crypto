...
HD_PWD='E:/EOS/project/project_1/project_1.runs/system_switch_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_switch_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_switch_0.tcl
